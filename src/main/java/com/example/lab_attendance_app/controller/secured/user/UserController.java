package com.example.lab_attendance_app.controller.secured.user;

import com.example.lab_attendance_app.enums.ExecutionStatus;
import com.example.lab_attendance_app.models.dto.CountDTO;
import com.example.lab_attendance_app.models.dto.MessageResponse;
import com.example.lab_attendance_app.models.dto.UserCreationDTO;
import com.example.lab_attendance_app.models.dto.UserDTO;
import com.example.lab_attendance_app.models.dto.authentication.ChangePasswordDTO;
...
public class UserController {
    ...
    public ResponseEntity<MessageResponse> updateUser(@PathVariable Integer id, @RequestBody UserCreationDTO userCreationDTO) {
        ...
        userCreationDTO.setEnabled(user.getEnabled());
        userCreationDTO.setExpired(user.getExpired());
        userCreationDTO.setLocked(user.getLocked());
        userCreationDTO.setCredentialsExpired(user.getCredentialsExpired());
    ...
    public ResponseEntity<Page<UserDTO>> searchUsers(
        ...
        boolean isRoleEmpty = (role== null || role.isEmpty());
        Page<User> result;
